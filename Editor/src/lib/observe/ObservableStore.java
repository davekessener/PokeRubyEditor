...
public interface ObservableStore<T> extends IObservable, Store<T>
{
	...
	public static <T> ObservableStore<T> Instantiate(Store<T> s, IObservable t)
	{
		return (ObservableStore<T>) Proxy.newProxyInstance(
				...
				new BindingInvocation(
					(new InvocationCollection())
						...
						.addInvocation(ClassCastFilter(IObservable.class), DeferredInvocation(t))));
	}
}
